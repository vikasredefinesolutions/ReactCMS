        ...
        <div className="flex justify-between items-center space-x-6 text-sm border-b border-slate-200 pb-4">
            <div className="lg:flex-1 flex flex-wrap items-center gap-4 leading-none">
                <div className="flex items-center gap-2">
                    <button
                        className={`inline-block ${productView === 'grid' && 'text-anchor-hover'
                            }`}
                    ...
                    <button
                        className={`inline-block ${productView === 'list' && 'text-anchor-hover'
                            }`}
                        ...
                        >
                            <div className="">
                                ...
                                >
                                    ...
                                    <span className="material-icons-outlined">expand_{showSortMenu ? 'less' : 'more'}</span>
                                </button>
                            </div>
                            {showSortMenu && (
