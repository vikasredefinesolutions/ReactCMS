...
const ProductLayout2 = ({
    ...
    return (
        productView === 'grid' ? <li className="text-center relative border border-gray-100 hover:border-gray-300 hover:shadow-md pb-10">
            ...
            <div className="mt-6">
                ...
                <div className="mt-4 text-gray-900">
                    <span className="font-bold">MSRP <Price value={product.salePrice} /></span>
                </div>
                ...
                >
                    {
                        product.getProductImageOptionList.map((option) => (
                            <li
                                className={`w-8 h-8 text-center border-2${option.id === currentProduct.id
                                    ? ' border-secondary'
                                    : ''
                ...
                <div className="relative flex flex-wrap -mx-3">
                    ...
                    <div className="w-full md:w-3/4 px-3">
                        ...
                        <ul role="list" className="flex items-center mt-4">
                            {product.getProductImageOptionList.map((option) => (
                                <li
                                    className={`w-8 h-8 text-center border-2${option.id === currentProduct.id ? ' border-secondary' : ''
                                        } hover:border-primary`}
                                    onClick={() => {
                                        colorChangeHandler(
                                            product.id,
