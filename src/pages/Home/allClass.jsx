        ...
        <div className="col-span-1 mt-4 md:mt-10 px-2 md:px-4 sm:px-0 sm:mt-16 lg:mt-0">
            <div className="flex flex-wrap">
                <div className="w-full md:w-2/3">
                    <h1 className="text-3xl font-semibold text-gray-900">Patagonia Men's Better Sweater Jacket</h1>
                    <div className="text-gray-700 pt-1 text-sm"><span className="font-semibold inline-block w-16">SKU
                        </span><span>: 25528</span></div>
                    <div className="text-gray-700 pt-1 text-sm"><span className="font-semibold inline-block w-16">MSRP
                        </span><span>: $139.00</span></div>
                </div>
                <div className="w-full md:w-1/3 mt-2 md:text-right text-sm font-semibold text-indigo-500"><a
                        href="request-consultation.html" className="text-indigo-500 underline">Request Consultation and
                        Proof</a> &gt;</div>
            </div>
            <div>
                <div
                    className="text-sm text-gray-600 bg-primary flex flex-wrap justify-between items-center p-2 md:p-0 md:pl-2 my-2">
                    <span className="text-lg font-bold text-white">Available Colors:</span></div>
                ...
                <div className="text-right"><a href="javascript:void(0);" className="" onclick="seeallcolor(this)"><span
                            className="span1">See All</span> <span className="span2">12</span> <span
                            className="span3">Colors</span></a></div>
            </div>
            <div className="mt-3">
            ...
            <div>
                <div
                    ...
                    <span className="text-lg font-semibold text-white">Discount Pricing:</span> <a
                ...
                <div className="text-sm text-gray-900 flex flex-wrap justify-between items-center mt-2">
                    <p className=""><span className="text-lg font-semibold mr-1">Price: $139.00</span>per item</p><a
                        href="javascript:void(0);" className="uppercase items-center" data-toggle="collapse"
                ...
                <div className="bg-gray-100 flex flex-wrap text-center border border-gray-300">
                    <div className="hidden md:block text-left">
                        <div className="p-1 px-2 border-r border-b border-gray-300 font-semibold">Quantity:</div>
                        <div className="p-1 px-2 border-r border-gray-300 font-semibold">Price:</div>
                    </div>
                    <div className="flex flex-wrap text-center grow">
                        ...
                        <div className="sm:w-1/5">
                            <div className="p-1 px-2 border-b border-gray-300">144+</div>
                ...
                <div className="mt-3 border border-gray-700 p-2 flex flex-wrap justify-between items-center gap-y-2">
                    <div className="w-full md:w-1/2 text-lg font-bold text-gray-900"><span className="w-full block">LOGIN OR
                            CREATE AN ACCOUNT</span> <span className="w-full block text-base font-normal">to see discounted
                            pricing on this product.</span></div>
                    <div className="w-full md:w-1/2 text-left flex justify-end"><button data-modal-toggle="LoginModal"
                            type="button"
                            className="btn btn-secondary !flex !py-4 items-center justify-center w-full uppercase">Login /
            ...
            <div className="m-3 flex flex-wrap text-gray-900 justify-between items-center">
                <div className="text-lg"><span className="font-semibold">Available Size(s):</span> <span>XS, SM, MD, LG, XL,
                        XXL, 3XL</span></div>
                <div><button type="button" className="text-indigo-500 text-sm font-semibold underline"
            ...
            <div className="text-lg m-3">
                ...
                <div><a href="javascript:void(0);" className="text-indigo-500 text-sm font-semibold underline">Patagonia
            ...
            <div className="mt-3 hidden">
                ...
                <div className="flex items-center">
                    <div className="flex items-center"><svg className="h-5 w-5 flex-shrink-0 text-indigo-500"
                        ...
                        </svg> <svg className="h-5 w-5 flex-shrink-0 text-indigo-500"
                        ...
                        </svg> <svg className="h-5 w-5 flex-shrink-0 text-gray-300"
                            x-state-description="undefined: &quot;text-indigo-500&quot;, undefined: &quot;text-gray-300&quot;"
                            x-description="Heroicon name: solid/star" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path
            ...
            <div className="m-3">
                ...
                <div
                    className="relative text-sm text-gray-700 tracking-widest div_description transition-all pb-8 h-40 overflow-hidden">
                    <div className="pb-3">
                    ...
                    <div
                        className="bg-gradient-to-b from-[#fffefe00] to-[#ffffff] absolute bottom-0 left-0 right-0 pt-20 text-center">
                        <a href="javascript:void(0);" className="text-indigo-500 underline text-sm font-bold"
                            onclick="more_description(this)">Read More</a></div>
                </div>
            </div>
            <form className="mt-6">
                <div className="mt-10"><button type="button" data-modal-toggle="startorderModal"
                        className="btn btn-xl btn-secondary !flex items-center justify-center w-full uppercase">Start
                        Order</button></div>
                <div className="mt-5 text-center"><a href="request-consultation.html"
                        className="text-indigo-500 text-lg font-semibold underline">Or request a free consultation with one
                        of our experts</a></div>
            </form>
            <div className="w-full text-center mt-5 py-3 text-sm leading-none">
                <div
                    className="block xl:inline-block px-3 xl:border-r border-slate-800 border-b border-b-black xl:border-b-0 last:border-b-0 py-2.5 xl:py-0">
                    <div className="w-full xl:w-auto flex flex-wrap justify-center items-center"><span
                            className="material-icons text-4xl">local_shipping</span>
                ...
                <div
                    className="block xl:inline-block px-3 border-b border-b-black xl:border-b-0 last:border-b-0 py-2.5 xl:py-0">
                    <div className="w-full xl:w-auto flex flex-wrap justify-center items-center"><span
                            className="material-icons text-4xl">style</span>
                        <div className="ml-2 text-left">
                ...
                <div
                    className="block xl:inline-block px-3 xl:border-l border-slate-800 border-b border-b-black xl:border-b-0 last:border-b-0 py-2.5 xl:py-0">
                    <div className="w-full xl:w-auto flex flex-wrap justify-center items-center"><span
                            className="material-icons text-4xl">verified</span>
                        <div className="ml-2 text-left">
