...
import ContactUs from '../Ecommerce_ContactUs';
import NewsLetterBox from '../Ecommerce_NewsLetterBox';
import CopyRight from './Ecommerce_CopyRight';
import Features from './Ecommerce_Footer_Features';
import OnePercentSection from './Ecommerce_OnePercentSection';
interface _props {}
