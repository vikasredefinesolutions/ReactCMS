...
const Ecommerce_Footer: React.FC<_props> = () => {
  ...
  //                 <Link
  //                   href="https://www.facebook.com/Gameday-Gear-265243084178573"
  //                   title="Facebook"
  //                   target="_blank"
  //                   rel="noreferrer"
  //                 >
  //                   <i className="!text-primary fa-brands fa-facebook-f text-3xl"></i>
  //                 </Link>
  //                 <Link
  //                   href="https://twitter.com/gamedaygear_usa"
  //                   title="Twitter"
  //                   target="_blank"
  //                   rel="noreferrer"
  //                 >
  //                   <i className="!text-primary fa-brands fa-twitter text-3xl"></i>
  //                 </Link>
  //                 <Link
  //                   href="https://www.pinterest.com/gamedaygear/"
  //                   title="Pinterest"
  //                   target="_blank"
  //                   rel="noreferrer"
  //                 >
  //                   <i className="!text-primary fa-brands fa-pinterest-p text-3xl"></i>
  //                 </Link>
  //                 <Link
  //                   href="https://www.youtube.com/channel/UCPmWWBDqJRFKkjAivV9H4tQ"
  //                   title="Youtube"
  //                   target="_blank"
  //                   rel="noreferrer"
  //                 >
  //                   <i className="!text-primary fa-brands fa-youtube text-3xl"></i>
  //                 </Link>
  //                 <Link
  //                   href="https://www.flickr.com/photos/157070492@N06/albums"
  //                   title="Flickr"
  //                   target="_blank"
  //                   rel="noreferrer"
  //                 >
  //                   <i className="!text-primary fa-brands fa-flickr text-3xl"></i>
  //                 </Link>
  //                 <Link
  //                   href="https://www.instagram.com/gameday.gear/"
  //                   title="Instagram"
  //                   target="_blank"
  //                   rel="noreferrer"
  //                 >
  //                   <i className="!text-primary fa-brands fa-instagram  text-3xl"></i>
  //                 </Link>
  //                 <Link
  //                   href="https://www.linkedin.com/company/gamedaygear"
  //                   title="LinkedIn"
  //                   target="_blank"
  //                   rel="noreferrer"
  //                 >
  //                   <i className="!text-primary fa-brands fa-linkedin-in  text-3xl hover:text-white"></i>
  //                 </Link>
  //               </div>
  //             </div>
  //           </div>
