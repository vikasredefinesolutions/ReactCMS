...
const Ecommerce_Header: React.FC = () => {
  ...
  if (storeLayout === _Store.type4) {
      return (
          <>
              <section className="sticky top-0 z-20" style={{background : "url('https://www.drivingi.com/images/home-bg.jpg')"}} id="header">
                <div className="bg-white text-black py-1 hidden md:block text-sm">
                    <div className="container mx-auto">
                        <div className="w-full items-center text-center">
                            <div className="items-center"> Email: <a href="mailto:info@drivingi.com" title="info@drivingi.com">info@drivingi.com</a> <span className="mx-2">OR</span> Call: <a href="tel:+18887374864" title="888.737.4864">888.737.4864</a></div>
                        </div>
                    </div>
                </div>
                <div className=""> 
                        ...
                        <div className="fixed inset-0 flex z-40">
                            <div className="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto">
                                <div className="px-4 pt-5 flex">
                                    <button type="button" className="-m-2 p-2 rounded-md inline-flex items-center justify-center text-gray-400"> <span className="sr-only">Close menu</span>
                                ...
                                <div className="my-6 px-0 border-t border-gray-300"> 
                                    <div className="text-sm border-b border-gray-300" >
                                        <div className="flex items-center justify-between py-2 pr-2">
                                            <button className="flex items-center grow group" aria-expanded="false">
                                                <svg className="w-8 h-8 shrink-0 fill-current text-gray-400 group-hover:text-gray-500" viewBox="0 0 32 32">
                                        ...
                                        <div className="bg-gray-100" x-show="open" x-cloak>
                                            <div className="border-t first:border-t-0 py-5 px-6">
                                                <ul role="list" aria-labelledby="desktop-featured-heading-1" className="flex flex-wrap gap-y-2">
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Casual </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Boxers </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Outdoor </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Artwork Tees </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Pants </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Accessories </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Boxers </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Basic Tees </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Casual </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Boxers </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Outdoor </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Artwork Tees </a> </li>
                                    ...
                                    <div className="text-sm border-b border-gray-300">
                                        ...
                                        <div className="bg-gray-100" x-show="open" x-cloak>
                                            <div className="border-t first:border-t-0 py-5 px-6">
                                                <ul role="list" aria-labelledby="desktop-featured-heading-1" className="flex flex-wrap gap-y-2">
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Polo </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Quarter Zips & Pullovers </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Jackets </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Hoodies & Sweetshirts </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Vests </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> T-Shirts </a> </li>
                                                    <li className="w-full lg:w-1/3 flex items-center"><span className="material-icons-outlined text-lg">chevron_right</span> <a href="product-listing.html" className="text-anchor hover:text-anchor-hover"> Shirts </a> </li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="text-sm border-b border-gray-300" x-data="{ open: false }">
                                        <div className="flex items-center justify-between py-2 pr-2">
                                            <button className="flex items-center grow group" aria-expanded="false">
                                                <svg className="w-8 h-8 shrink-0 fill-current text-gray-400 group-hover:text-gray-500" viewBox="0 0 32 32">
                                                    <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z"></path>
                                    ...
                                    <div className="text-sm border-b border-gray-300" x-data="{ open: false }">
                                        <div className="flex items-center justify-between py-3 px-2 pl-8">
                                            <div className=""><a href="product-listing.html" className="">Accessories</a></div>
                                        </div>
                                    </div>
                                    <div className="text-sm border-b border-gray-300" x-data="{ open: false }">
                                        <div className="flex items-center justify-between py-3 px-2 pl-8">
                                            <div className=""><a href="product-listing.html" className="">Contact / Quote</a></div>
                                        </div>
                                    </div>
                                    <div className="text-sm border-b border-gray-300" x-data="{ open: false }">
                                        <div className="flex items-center justify-between py-3 px-2 pl-8">
                                            <div className=""><a href="product-listing.html" className="">Catalogs</a></div>
                                        </div>
                                    </div>
                    ...
                    <header className="relative">
                        <nav aria-label="Top"> 
                            <div className="">
                                <div className="container mx-auto">
                                    <div className="py-3 lg:py-4 flex items-center justify-between">
                                        <div className="hidden lg:flex lg:items-center"> <a href="index.html"> <span className="sr-only">Workflow</span> <img className="h-16 w-auto" src="/images/logo.png" alt="Corporate Gear" /> </a> </div>
                                        <div className="hidden h-full lg:flex items-center justify-center flex-1"> 
                                            <div className="ml-6" x-data="Components.popoverGroup()" x-init="init()">
                                              <div className="h-full flex justify-center space-x-6 relative">
                                                  <div className="flex"
                                                      ...
                                                      <div className="relative flex">
                                                          <button type="button"
                                                              className="relative z-10 flex items-center transition-colors ease-out duration-200 text-md font-medium border-0 border-b-2 py-2 border-transparent text-white hover:text-primary-hover"> <span className="text-white">Brands</span> 
                                                              <svg className="w-8 h-8 shrink-0 fill-current text-anchor-hover group-hover:text-gray-500 ml-3" viewBox="0 0 32 32">
                                                                  <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z"></path>
                                                              </svg> 
                                                          </button>
                                                      </div>
                                                  ...
                                                  <div className="flex">
                                                      <div className=""> <a href="product-listing.html" className="relative z-10 flex items-center transition-colors ease-out duration-200 text-md font-medium border-0 border-b-2 py-2 border-transparent text-white hover:text-primary-hover hover:border-b-primary" > <span className="text-white">Accessories</span> </a> </div>
                                                  </div>
                                                  <div className="flex">
                                                      <div className=""> <a href="product-listing.html" className="relative z-10 flex items-center transition-colors ease-out duration-200 text-md font-medium border-0 border-b-2 py-2 border-transparent text-white hover:text-primary-hover hover:border-b-primary" > <span className="text-white">Contact / Quote</span> </a> </div>
                                                  </div>
                                                  <div className="flex">
                                                      <div className=""> <a href="product-listing.html" className="relative z-10 flex items-center transition-colors ease-out duration-200 text-md font-medium border-0 border-b-2 py-2 border-transparent text-white hover:text-primary-hover hover:border-b-primary" > <span className="text-white">Catalogs</span> </a> </div>
                                                  </div>
                                              </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center lg:hidden space-x-4">
                                            <button type="button" x-description="Mobile menu toggle, controls the 'mobileMenuOpen' state." className="py-2 rounded-md text-white hover:text-primary" > <span className="sr-only">Open menu</span>
                                                <svg className="h-6 w-6" x-description="Heroicon name: outline/menu" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16"></path>
                                                </svg>
                                            </button>
                                            
                                            <a href="#" className="py-2 text-white hover:text-gray-500"> <span className="sr-only">Search</span>
                                                <svg className="w-6 h-6" x-description="Heroicon name: outline/search" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                                </svg>
                                            </a> 
                                        </div>
                                        
                                        <a href="index.html" className="lg:hidden"> <img src="../images/logo.png" alt="" className="h-8 w-auto" /> </a>
                                        <div className="flex items-center justify-end">
                                            <div className="flex items-center lg:ml-6">
                                                <div className="flex items-center space-x-4">
                                                    <div className="hidden lg:flex"> <a href="#" className="-m-2  border border-primary p-2 pr-10 text-gray-400 hover:text-gray-500 rounded-md relative">
                                                        <input type="text" className="outline-none bg-transparent text-white focus:shadow-none focus:border-none placeholder:text-gray-400 border-transparent" placeholder="Search" />
                                                        <div className="w-6 h-6 absolute right-2 top-4">
                                                            <SearchIcon className="w-6 h-6 stroke-primary"/>
                                                        </div>
                                                        </a> 
                                                    </div>
                                                    <div className="flex"> <a href="javascript:void(0);" className="lg:mx-2 py-2 text-white hover:text-white flex items-center gap-1" data-modal-toggle="LoginModal"> <span className="lg:hidden material-icons-outlined">person</span> <span className="lg:inline-block">Login</span> </a> </div>
                                                    {/* <!-- <span className="mx-4 h-6 w-px bg-gray-200 lg:mx-6" aria-hidden="true"></span> --> */}
                                                    <div className="flow-root"> <a href="cart.html" className="lg:mx-2 py-2 text-white hover:text-white flex items-center gap-1"> <span className="lg:hidden material-icons-outlined">shopping_cart</span> <span className="lg:inline-block">My Cart</span> </a> </div>
                                                    <div className="flow-root"> <a href="#" className="text-primary hover:text-gray-500 flex items-center gap-1"><img src="images/for-the-planet.png" title="" alt="" /></a> </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
